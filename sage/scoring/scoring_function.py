...
from sage.utils.chemistry import smiles_to_rdkit_mol
from sage.scoring.score_modifier import ScoreModifier, LinearModifier
from sage.utils.math import geometric_mean
...
class ScoringFunctionWrapper(ScoringFunction):
    ...
    def score_batch(self, smiles_list):
        ...
        return self.scoring_function.score_batch(smiles_list)
