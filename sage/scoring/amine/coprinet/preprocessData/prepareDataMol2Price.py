...
from sage.scoring.amine.coprinet.config import USE_MMOL_INSTEAD_GRAM
from sage.scoring.amine.coprinet.preprocessData.serializeDatapoints import getExampleId, serializeExample
from sage.scoring.amine.coprinet.utils import tryMakedir, getBucketRanges, search_buckedId, EncodedDirNamesAndTemplates
...
'''
python -m  sage.scoring.amine.coprinet.preprocessData.prepareDataMol2Price
