...
from sage.scoring.amine.coprinet.config import TEST_SIZE
from sage.scoring.amine.coprinet.selectFromRawData.selectFromRawDataNonVirtualAll_base import RawDataSelector
...
if __name__ == "__main__":
    ...
    '''
python -m sage.scoring.amine.coprinet.selectFromRawData.selectFromRawDataNonVirtualAll
    '''