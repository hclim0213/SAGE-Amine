...
INSTOCK_MODEL = "/home/coprinet/epoch=238-step=1295857.ckpt"
VIRTUAL_MODEL = "/home/coprinet/epoch=172-step=3231639.ckpt"

def DEFAULT_MODEL(keyword='instock') -> str:
    if keyword == 'instock':
        return INSTOCK_MODEL
    else:
