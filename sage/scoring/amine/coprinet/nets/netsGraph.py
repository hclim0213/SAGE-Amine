...
from sage.scoring.amine.coprinet import config
from sage.scoring.amine.coprinet.ArgParser_base import ArgParseable
from sage.scoring.amine.coprinet.config import USE_FEATURES_NET
from sage.scoring.amine.coprinet.nets.FDS_imbalance import FDS
...
class PricePredictorModule(pl.LightningModule, ArgParseable):
    ...
    def __init__(
        ...
        if gnn_class == "GNN_PNAConv":
            from sage.scoring.amine.coprinet.nets.basicArchitectures import GNN_PNAConv as GNN
        elif gnn_class == "GNN_AttentiveFP":
            from sage.scoring.amine.coprinet.nets.basicArchitectures import GNN_AttentiveFP  as GNN
        elif gnn_class == "QdolarAR":
            assert USE_FEATURES_NET
            from sage.scoring.amine.coprinet.nets.basicArchitectures import QdolarAR as GNN
...
if __name__ == "__main__":
    ...
    if gnn_class != "QdolarAR":
        ...
        from sage.scoring.amine.coprinet.preprocessData.smilesToDescriptors import smiles_to_graph
