...
from sage.scoring.amine.coprinet.dataManager.dataset import Dataset_graphPrice
from sage.scoring.amine.coprinet.preprocessData.prepareDataMol2Price import DataBuilder
from sage.scoring.amine.coprinet.utils import EncodedDirNamesAndTemplates
...
if __name__ == "__main__":
    ...
    from sage.scoring.amine.coprinet.ArgParser_base import ArgParseable, MyArgParser
    ...
    '''
python -m sage.scoring.amine.coprinet.dataManager.dataManager
    '''
