...
class TransformerConvNetwork(AbstractExplainer):
    def __init__(
        self,
        input_size: int,
        hidden_size: int,
...
class TransformerConvLayer(torch.nn.Module):
    def __init__(
        ...
        super().__init__()
        self.conv = TransformerConv(in_features, out_features // num_heads, heads=num_heads, concat=concat, dropout=dropout)
